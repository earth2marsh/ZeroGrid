/**
 * ZeroGrid is derived from ZeroBin 0.15
 *
...
function scriptLocation() {
    return "https://api.usergrid.com/5af333d7-6c65-11e1-8b9e-1231381a0091/bins"
...
function send_data() {
    ...
    var data_to_send = { data:           JSON.parse(cipherdata),
                         expire:         "never", //$('select#pasteExpiration').val(),
                         opendiscussion: $('input#opendiscussion').is(':checked') ? 1 : 0
                       };
//    amgdata = data_to_send;
// orig    $.post(scriptLocation(), data_to_send, 'json')
	$.ajax({data: JSON.stringify(data_to_send),
    	type: "POST",
...
// TODO set the bin URL to be the hosted location, and set the usergrid uuid for the bin appropriately
// also build out index.html to retrieve a given bin and decode it
